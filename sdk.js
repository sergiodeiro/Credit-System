/*1538074562,,JIT Construction: v4358221,pt_BR*/
...
try {
    (function() {
        var a = "https://developers.facebook.com/docs/accountkit/integratingweb#configureloginhtml";
        if (!window.AccountKit || !window.AccountKit.doNotLinkToSDKDirectly) throw new Error("Please ensure the AccountKit SDK is hotlinked directly. See " + a)
    })();
        ...
        for (var i = 0; i < sandboxWhitelist.length; i++) {
            ...
            with(this) {
                ...
                __d("AccountKitJSSDKRuntimeConfig", [], {
                    ...
                    "popupproxy": "\/dialog\/popup_proxy\/r\/dTLZjhBrrT8.js",
                    "pollingframe": "\/dialog\/polling_frame\/r\/DOrje3X3RQq.js"
                });
                ...
                __d("ak.Runtime", ["AccountKitJSSDKRuntimeConfig", "guid", "sdk.Model"], (function(a, b, c, d, e, f, g, h, i) {
                    a = new i({
                        AppID: "",
                        State: "",
                        LoggingRef: h(),
                ...
                __d("ErrorUtils", ["CometErrorUtils", "Env", "ErrorConstants", "eprintf", "erx", "removeFromArray", "sprintf"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
                    "use strict";
                    __p && __p();
                    ...
                    var I = {
                        ...
                        addListener: function(a, b) {
                            b === void 0 && (b = !1), q.push(a), b || ES(s, "forEach", !0, function(b) {
                        ...
                        applyWithGuard: function(b, c, d, e, f, g) {
                            ...
                            try {
                                ...
                                if (f == null) try {
                                    ...
                                    var q = m(o, p ? p : "this function does not support toString", j, c);
                                    f = new Error(q);
                                    ...
                                    p = m(q, o ? o : "this function does not support toString", a.message);
                                    f = new Error(p);
                        ...
                        guard: function(a, b, c) {
                            ...
                            function d() {
                                return I.applyWithGuard(a, c || this, [].concat(Array.prototype.slice.call(arguments)), null, b)
                            }
                        ...
                        normalizeError: function(a) {
                            ...
                            if (a.framesToPop) {
                                ...
                                p.test(a.message) && a.framesToPop === 2 && f && (o.test(f.script) && (a.message += " at " + f.script + (f.line ? ":" + f.line : "") + (f.column ? ":" + f.column : "")))
                            }
                            ...
                            typeof b.message === "string" ? b.messageWithParams = b.messageWithParams || k(b.message) : (b.messageObject = b.message, b.message = String(b.message) + " (" + typeof b.message + ")");
                            b.messageWithParams && (b.message = j.apply(undefined, b.messageWithParams));
                        ...
                        onerror: function(a, b, c, d, e) {
                            e = e || {}, e.message = e.message || a, e.script = e.script || b, e.line = e.line || c, e.column = e.column || d, e.guard = i.GLOBAL_ERROR_HANDLER_TAG, e.guardList = [i.GLOBAL_ERROR_HANDLER_TAG], I.reportError(e, !0, "FATAL")
                        },
                        reportError: function(b, c, d) {
                            ...
                            u.length > 0 && (b.guard = b.guard || u[0], b.guardList = u.slice());
                ...
                __d("URIBase", ["FBLogger", "URIRFC3986", "URISchemes", "ex", "invariant", "setHostSubdomain"], (function(a, b, c, d, e, f, g, h, i, j, k, l) {
                    ...
                    function q(a, b) {
                        "use strict";
                        b || k(0, undefined), this.$9 = b, this.$7 = "", this.$1 = "", this.$6 = "", this.$5 = "", this.$3 = "", this.$4 = !1, this.$8 = {}, this.$2 = !1, o(this, a, !0, b)
                    }
                    q.prototype.setProtocol = function(a) {
                        "use strict";
                        i.isAllowed(a) || (g("uri").mustfix("You attempted to set the protocol of a URI to `%s`. That protocol does not pass the `URISchemes.isAllowed` test.", a), k(0, undefined, a));
                        this.$7 = a;
                        return this
                    };
                ...
                __d("ak.Impressions", ["ak.Runtime", "getBlankIframeSrc", "guid", "insertIframe", "sdk.Content", "sdk.URI"], (function(a, b, c, d, e, f, g, h, i, j, k, l) {
                    __p && __p();

                    function a(event, a) {
                        __p && __p();
                        a = a || {};
                        var b = window.location.origin || new l(window.location.href).getOrigin();
                        a.origin = b;
                        a.app_id = g.getAppID();
                ...
                __d("ak.feature", ["AccountKitJSSDKFeatureConfig", "sdk.FeatureFunctor"], (function(a, b, c, d, e, f, g, h) {
                ...
                __d("ak.ErrorHandling", ["ak.feature", "ak.Impressions", "sdk.ErrorHandler"], (function(a, b, c, d, e, f, g, h, i) {
                    a = g("e_handler", !1);
                    e.exports = i.create(a, function(a) {
                        h.log("e_handler", {
                            details: a.name || a.message,
                            error: a
                        })
                    })
                }), null);
                __d("ak.protect", ["ak.ErrorHandling"], (function(a, b, c, d, e, f, g) {
                    __p && __p();
                    ...
                    function h(a, b, c, d) {
                        ...
                        return g.guard(function() {
                            ...
                            function e(a) {
                                ...
                                return a && typeof a === "object" && a.__wrapped ? a.__wrapped : typeof a === "function" && /^function/.test(a.toString()) ? g.unguard(a) : a
                            }
                            ...
                            if (i && typeof i === "object") {
                                ...
                                for (var c in i) {
                                    var l = i[c];
                                    if (typeof l !== "function" || c === "constructor") continue;
                                    k = !1;
                                    j[c] = h(l, b + ":" + c, c, i)
                                }
                            }
                ...
                __d("AccountKit", ["Log", "ak.protect", "sdk.domReady"], (function(a, b, c, d, e, f, g, h, i) {
                    __p && __p();
                ...
                __d("ak.init", ["ak.ErrorHandling", "ak.feature", "ak.Impressions", "ak.Runtime", "sdk.UA"], (function(a, b, c, d, e, f, g, h, i, j, k) {
                    __p && __p();
                    var l = "https://developers.facebook.com/docs/accountkit/integratingweb#configureloginhtml";

                    function m(a) {
                        var b = typeof a === "number" && a > 0 || typeof a === "string" && /^[0-9]{1,21}$/.test(a);
                        if (b) return a.toString();
                        throw new Error("Invalid App Id: Must be a number or numeric string representing the application id. For more details, see " + l)
                    }

                    function n(a) {
                        if (typeof a === "string" && /^v\d+\.\d\d?$/.test(a)) return a;
                        throw new Error('Invalid version: must be in the form "v{major}.{minor}". For more details, see ' + l)
                    }

                    function a(a) {
                        __p && __p();
                        if (j.getInitialized()) throw new Error("AccountKit.init has already been called. This indicates a problem in your code.");
                        var b = m(a.appId);
                        j.setAppID(b);
                        a.fbAppEventsEnabled === !1 ? j.setFBAppEventsEnabled(!1) : j.setFBAppEventsEnabled(!0);
                        a.redirect && j.setRedirect(a.redirect);
                        k.inAppBrowser() || k.ucBrowser() ? j.setDisplay("modal") : a.display && j.setDisplay(a.display);
                    ...
                    setTimeout(function() {
                        typeof window.AccountKit_OnInteractive === "function" && !window.AccountKit_OnInteractive.hasRun && (window.AccountKit_OnInteractive.hasRun = !0, g.unguard(window.AccountKit_OnInteractive)())
                    }, 0);
                    e.exports = a
                }), null);
                __d("legacy:ak.init.legacy", ["AccountKit", "ak.init"], (function(a, b, c, d, e, f, g, h) {
                    g.provide({
                        init: h
                    })
                }), 3);
                __d("ak.PopupMonitor", ["ak.feature", "ak.Impressions"], (function(a, b, c, d, e, f, g, h) {
                    __p && __p();
                    var i, j, k;
                    ...
                    function l(a, b) {
                        var c = !1;
                        try {
                            !a || a.closed && (j || !j && k) ? b(j) : a.closed && !j ? (k = !0, c = !0) : c = !0
                        } catch (a) {
                            g("e_popup_not_opened", !0) && h.log("e_popup_not_opened", {
                                details: a.name || a.message
                            })
                        }
                        c && !i ? i = setInterval(ES(l, "bind", !0, this, a, b), 100) : !c && i && m()
                    }
                    ...
                    e.exports = {
                        monitor: a,
                        cancel: m,
                        setIsResponseReceived: b
                    }
                }), null);
                __d("ak.PopupWindow", ["ak.PopupMonitor", "sdk.UA"], (function(a, b, c, d, e, f, g, h) {
                    __p && __p();
                    ...
                    function a(a, b, c, d) {
                        __p && __p();
                        var e = window.screenX !== undefined ? window.screenX : window.screenLeft,
                            f = window.screenY !== undefined ? window.screenY : window.screenTop;
                        j && (g.cancel(), j.close());
                        if (c === "modal") {
                            c = function() {
                            ...
                            d && (v.onload = function() {
                                var a = "If X-Frame-Options is set to deny, please update the origin URL in the Account Kit developer page. If the iframe loads properly, please disregard this message. Remember to turn off debug mode in production.";
                                !1
                            });
                            v.setAttribute("src", a);
                            v.setAttribute("width", t + "px");
                            v.setAttribute("height", u + "px");
                            v.setAttribute("style", "border:none;");
                            d = "height:" + u + "px;";
                            d += "width:" + t + "px;";
                            d += "position:fixed;";
                            window.scrollY || window.scollTop || document.getElementsByTagName("html")[0].scrollTop;
                            h.mobile() ? (d += "top:" + k + "px;", d += "left:" + k + "px;") : (d += "top:" + (n() / 2 - r() / 2) + "px;", d += "left:" + (o() / 2 - s() / 2) + "px;");
                            d += "z-index:1000;";
                            ...
                            x.setAttribute("style", d);
                            x.appendChild(v);
                            document.body !== null && document.body.appendChild(x);
                            document.body !== null && document.body.appendChild(w);
                            t = function a(event) {
                                event.data === i && (window.removeEventListener("message", a, !1), x.remove(), w.remove())
                            };
                            window.addEventListener("message", t, !1);
                            if (h.mobile()) {
                                u = function(event) {
                                    v.setAttribute("height", r() + "px;"), v.setAttribute("width", s() + "px;")
                                };
                                window.addEventListener("resize", u, !1)
                            }
                            w.addEventListener("click", c, !1)
                        } else {
                            d = h.mobile() ? 0 : l;
                            t = h.mobile() ? 0 : m;
                            u = [];
                            c = e < 0 ? window.screen.width + e : e;
                            e = parseInt(c + (q() - d) / 2, 10);
                            c = parseInt(f + (p() - t) / 2.5, 10);
                            d > 0 && u.push("width=" + d);
                            t > 0 && u.push("height=" + t);
                            u.push("left=" + e);
                            u.push("top=" + c);
                            u.push("scrollbars=1");
                            u.push("status=1,toolbar=0");
                            f = u.join(",");
                            j = window.open(a, "AccountKit_Popup", f);
                            if (!j) return;
                    ...
                    function n() {
                        var a;
                        return window.innerHeight !== undefined ? window.innerHeight : ((a = document.documentElement) == null ? void 0 : a.clientHeight) || 0
                    }

                    function o() {
                        var a;
                        return window.innerWidth !== undefined ? window.innerWidth : ((a = document.documentElement) == null ? void 0 : a.clientWidth) || 0
                    }

                    function p() {
                        var a;
                        return window.outerHeight !== undefined ? window.outerHeight : (((a = document.documentElement) == null ? void 0 : a.clientHeight) || 0) - 22
                    }

                    function q() {
                        var a;
                        return window.outerWidth !== undefined ? window.outerWidth : ((a = document.documentElement) == null ? void 0 : a.clientWidth) || 0
                    }

                    function r() {
                        return h.mobile() ? n() - k * 2 : Math.min(n(), m)
                    }

                    function s() {
                        return h.mobile() ? o() - k * 2 : Math.min(o(), l)
                    }
                    e.exports = {
                        open: a,
                        close: b,
                        modalClosedMessage: i
                    }
                }), null);
                ...
                __d("sdk.DOMEventListener", ["emptyFunction", "invariant", "wrapFunction"], (function(a, b, c, d, e, f, g, h, i) {
                    ...
                    window.addEventListener ? (k = function(a, b, c, d) {
                        ...
                        c.wrapper = i(c, "entry", "DOMEventListener.add " + b), a.attachEvent || h(0, undefined), a.attachEvent("on" + b, c.wrapper)
                    }, l = function(a, b, c) {
                        a.detachEvent || h(0, undefined), a.detachEvent("on" + b, c.wrapper)
                    }) : l = k = g;
                    b = {
                ...
                __d("ak.getAuthCode", ["Log", "ak.feature", "ak.Impressions", "ak.PopupMonitor", "ak.PopupWindow", "ak.Runtime", "sdk.DOMEventListener", "sdk.UA", "sdk.URI"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                    __p && __p();
                    var p = "AK_DIALOG_RESPONSE:",
                        q = "NOT_AUTHENTICATED";

                    function r(event) {
                        return event.origin !== undefined && new RegExp(/\.accountkit\.com$/).test(event.origin)
                    }
                    ...
                    function s(event, a) {
                        ...
                        if (c && ES(c, "startsWith", !0, p)) {
                            ...
                            try {
                                ...
                                h("e_login_resp_parse_failed", !0) && i.log("e_login_resp_parse_failed", {
                                    response: c
                                }), g.warn(a.toString()), b()
                            }
                        } else h("e_login_resp_parse_failed", !0) && i.log("e_login_resp_parse_failed", {
                            response: c
                        }), g.warn("Incorrect response body."), b()
                    }
                    ...
                    function t(a, b, c) {
                        ...
                        var d = a.endpoint;
                        delete a.endpoint;
                        var e = window.location.origin || new o(window.location.href).getOrigin();
                        a.origin = e;
                        a.app_id = l.getAppID();
                        a.state = l.getState();
                        ...
                        var f = m.add(window, "message", function(event) {
                            (r(event) === !0 || event.data === k.modalClosedMessage) && (s(event, b), f.remove())
                        });
                        k.open(d, function() {
                            f.remove(), c()
                        }, a.display, a.debug)
                ...
                __d("ak.input-validators", [], (function(a, b, c, d, e, f) {
                    __p && __p();
                ...
                __d("ak.loginWithEmail", ["Log", "ak.getAuthCode", "ak.input-validators", "ak.Runtime", "sdk.Content", "sdk.createIframe", "sdk.UA"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
                    __p && __p();
                    var n = !1,
                        o = !1;
                ...
                __d("ak.utils", ["ak.input-validators"], (function(a, b, c, d, e, f, g) {
                    function a(event) {
                        return event.origin !== undefined && new RegExp(/\.accountkit\.com$/).test(event.origin)
                    }
                    ...
                    e.exports = {
                        isAccountKitEvent: a,
                        isValidPhoneNumberParams: b
                    }
                }), null);
                __d("ak.loginWithPhone", ["Log", "ak.getAuthCode", "ak.Runtime", "ak.utils", "sdk.Content", "sdk.createIframe", "sdk.UA"], (function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
                    __p && __p();
                ...
                __d("ak.login", ["ak.loginWithEmail", "ak.loginWithPhone", "ak.Runtime"], (function(a, b, c, d, e, f, g, h, i) {
                    __p && __p();
                    ...
                    function a(a, b, c) {
                        if (!i.getInitialized()) throw new Error("AccountKit SDK was not initialized. Call AccountKit.init first.");
                        if (!j[a]) throw new Error("Unsupported login method: " + a);
                        if (!b) throw new Error('"params" object is not provided.');
                        j.PHONE === a ? h(b.countryCode, b.phoneNumber, c) : j.EMAIL === a && g(b.emailAddress, c)
                    }
                    e.exports = a
                }), null);
                __d("legacy:ak.login.legacy", ["AccountKit", "ak.login"], (function(a, b, c, d, e, f, g, h) {
                    g.provide({
                        login: h
                    })
                }), 3);
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"4358221","namespace":"AccountKit","message":"' + e.message + '"}}');
}